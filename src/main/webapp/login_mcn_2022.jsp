                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <small class="form-text text-muted"><img src="img/logo-horizontal.png.png" height="25px" alt="alt"/></small>
                                            <small class="form-text text-muted">E' possibile accedere in qualsiasi momento alla piattaforma Edubik inserendo l'ultima coppia di credenziali ricevuta sulla propria email.</small>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                </div>
